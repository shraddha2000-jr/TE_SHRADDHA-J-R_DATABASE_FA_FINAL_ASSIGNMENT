-------SCD TYPE 1-----------------------
---------------------SCD TYPE 1-------------------------------
CREATE TABLE [TE_FA_LOAN_SCDTYPE1] (
...
SELECT * FROM [TE_FA_LOAN_SCDTYPE1]

UPDATE [TE_FA_LOAN_SCDTYPE1]
SET Name='ECONOLODGE OF DUMAS', City='PLANO', State='TN'
WHERE LoanNr_ChkDgt=1000014003


----------------TARGET-------------------------------
CREATE TABLE [TE_FA_LOAN_SCDTYPE1_TAR] (
    [LoanNr_ChkDgt] varchar(50),
    [Name] varchar(50),
    [City] varchar(50),
    [State] varchar(50),
...
SELECT * FROM [TE_FA_LOAN_SCDTYPE1_TAR]    -- line num 1
...
CREATE TABLE TE_FA__CINEMA_AGGRE_S_L
( 
Film_Type	VARCHAR(20),
film_code	FLOAT,
cinema_code	 FLOAT,
...
SELECT * FROM TE_FA__CINEMA_AGGRE_S_L

CREATE TABLE TE_FA__CINEMA_AGGRE_S_M
( 
Film_Type	VARCHAR(20),
film_code	FLOAT,
cinema_code	 FLOAT,
...
SELECT * FROM TE_FA__CINEMA_AGGRE_S_M

CREATE TABLE TE_FA__CINEMA_AGGRE_S_H
( 
Film_Type	VARCHAR(20),
film_code	FLOAT,
cinema_code	 FLOAT,
...
SELECT * FROM TE_FA__CINEMA_AGGRE_S_H
